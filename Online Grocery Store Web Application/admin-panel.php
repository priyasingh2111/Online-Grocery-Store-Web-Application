...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $query = "UPDATE inventory SET UnitPrice = :newUnitPrice, QuantityInInventory = :newQuantity WHERE ItemNumber = :itemNumber";
    $statement = $pdo->prepare($query);
    $statement->bindParam(":newUnitPrice", $newUnitPrice);
    $statement->bindParam(":newQuantity", $newQuantity);
    $statement->bindParam(":itemNumber", $itemNumber);
