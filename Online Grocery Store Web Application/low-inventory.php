...
// Fetch low inventory items (quantity less than 3) from the database
$query = "SELECT * FROM inventory WHERE QuantityInInventory < 3";
$result = mysqli_query($conn, $query);

// Display low inventory items in a table
echo "<h2>Low Inventory Items</h2>";
echo "<table border='1'>
    <tr>
        <th>Item Number</th>
        <th>Name</th>
