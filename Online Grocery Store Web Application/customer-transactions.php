...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST["specificDate"])) {
        ...
        $query = "SELECT c.CustomerID, COUNT(t.TransactionID) AS TransactionCount
                    FROM carts c
                    JOIN transactions t ON c.TransactionID = t.TransactionID AND t.TransactionDate <= ?
...
<div class="container">
    <div class="main-content">
        <section class="register-form">
            ...
            if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["specificDate"])) {
                echo "<h2>Results:</h2>";
                echo "<table border='1'>";
                echo "<tr><th>CustomerID</th><th>TransactionCount</th></tr>";
                while ($row = $result->fetch_assoc()) {
                    echo "<tr><td>" . $row["CustomerID"] . "</td><td>" . $row["TransactionCount"] . "</td></tr>";
                }
                echo "</table>";
            }
            ?>
